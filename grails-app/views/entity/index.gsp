		...
		<div id="list-entity" class="content scaffold-list" role="main">
			...
			<thead>
					<tr>
						...
						<g:sortableColumn property="title" title="${message(code: 'entity.title.label', default: 'Title')}" />
				...
				<g:each in="${entityInstanceList}" status="i" var="entityInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td><g:link action="show" id="${entityInstance.id}">${fieldValue(bean: entityInstance, field: "title")}</g:link></td>
